...
ActiveRecord::Schema.define(version: 20151009150746) do
  ...
  add_index "comments", ["crime_id"], name: "index_comments_on_crime_id", using: :btree
  add_index "comments", ["user_id"], name: "index_comments_on_user_id", using: :btree
  add_index "comments", ["year_id"], name: "index_comments_on_year_id", using: :btree
